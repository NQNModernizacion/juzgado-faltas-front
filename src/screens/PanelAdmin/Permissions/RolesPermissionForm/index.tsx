...
//       <div className="flex gap-4">
//         {/* CARD: Rol */}
//         <div className="w-1/2 overflow-hidden rounded-lg border border-border bg-surface shadow-sm">
//           {/* header (evita herencias azules) */}
//           <div className="border-b border-border bg-primary/10 px-4 py-3">
//             <h5 className="text-base font-semibold text-primary-800">
