...
tinymce.addI18n('es', {
  ...
  'Accordion summary...': 'Resumen de Acordeón...',
  'Action': 'Acción',
  'Activity': 'Actividad',
  'Address': 'Dirección',
  'Advanced': 'Avanzado',
  ...
  'Press the Up and Down arrow keys to resize the editor.': 'Pulse las teclas de flecha arriba y abajo para cambiar el tamaño del editor.',
  'Press the arrow keys to resize the editor.': 'Pulse las teclas de flecha para cambiar el tamaño del editor.',
