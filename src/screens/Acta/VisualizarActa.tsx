...
export const VisualizarActa = () => {
  ...
  const {
    fields: infractoresFields,
    append: appendInfractor,
    remove: removeInfractor,
  } = useFieldArray({
    control,
    name: 'Infractores',
  })
  const {
    fields: patronesFields,
    append: appendPadron,
    remove: removePadron,
  } = useFieldArray({
    control,
  ...
  const {
    fields: infraccionesFields,
    append: appendInfraccion,
    remove: removeInfraccion,
  } = useFieldArray({
    control,
    name: 'Infracciones',
  })
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <SelectField
                ...
                name="calle_id"
                control={control}
                options={datosIniciales?.combos?.calles?.map((ley: any) => ({
                  value: ley.id,
                  label: ley.nombre,
                }))}
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <SelectField
                ...
                name="inspector_1_id"
                control={control}
                options={[{ value: 1, label: 'Comercio' }]}
