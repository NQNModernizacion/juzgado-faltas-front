...
export default function Roles() {
  ...
  return (
    <Container linkBack={'/administrador/roles-permisos'} title={'Administración de Roles'}>
                  ...
                  <div className="col-12">
                    <div className="card-body">
                      <div className="row">
                        ...
                        <h6 className="card-subtitle mb-4 text-body-secondary">¿Ha entrado a la aplicación?: {persona.data.in_app ? 'Sí' : 'No'}</h6>
                        ...
                        <div className="d-flex flex-wrap gap-2">
                          ...
                          {persona.data.roles.length === 0 && <h6 className="card-subtitle mb-2 text-body-secondary">No posee roles</h6>}
                        </div>
                      </div>
                    </div>
                  </div>
