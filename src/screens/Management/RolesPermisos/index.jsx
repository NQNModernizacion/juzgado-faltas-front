...
export default function RolesPermisos() {
  ...
  return (
    <Container linkBack={'/administrador/roles-permisos'} title={'Administración de Permisos de Roles'}>
      {roles.loading && (
      ...
      {rol.rol.length > 0 && (
        <button className="btn btn-primary" disabled={rol.loading} onClick={() => buscarRol(rol, setRol, permisos, setPermisos)}>
