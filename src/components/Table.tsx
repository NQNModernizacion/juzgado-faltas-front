        ...
        <div className="card mb-1 d-flex flex-row">
          ...
          <div className="d-flex flex-row p-2 ms-auto">
            <input
              id="search"
              type="search"
              className="block rounded-md border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
