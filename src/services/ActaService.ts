...
export const onSubmitAlta = async (formData: any, setIsLoading: any) => {
  try {
    ...
    formData.fecha_notificado = formData.fecha_notificado ? new Date(formData.fecha_notificado).toISOString().split('T')[0] : null
...
export const getEstadosProcesalesActa = async (id: any, setEstados: any, setIsLoading: any) => {
  try {
    setIsLoading(true)
...
export const postEstadoProcesal = async (payload: any, onSuccess: any, setIsLoading: any) => {
  try {
    setIsLoading(true)
...
export const getPruebasActa = async (id: any, setPruebas: any, setIsLoading: any) => {
  try {
    setIsLoading(true)
...
export const postPrueba = async (payload: FormData, onSuccess: any, setIsLoading: any) => {
  try {
    setIsLoading(true)
...
export const putPrueba = async (id: any, payload: FormData, onSuccess: any, setIsLoading: any) => {
  try {
    setIsLoading(true)
...
export const deletePrueba = async (id: any, onSuccess: any, setIsLoading: any) => {
  try {
    setIsLoading(true)
...
export const getMovimientosActa = async (id: any, setMovimientos: any, setIsLoading: any) => {
  try {
    setIsLoading(true)
...
export const postMoverCausa = async (payload: any, onSuccess: any, setIsLoading: any) => {
  try {
    setIsLoading(true)
    await axios().post(`mover_causa`, payload)
...
export const postAgruparActas = async (actasIds: any[], onSuccess: any, setIsLoading: any) => {
  try {
    setIsLoading(true)
...
export const postAgregarAGrupo = async (grupoId: any, actasIds: any[], onSuccess: any, setIsLoading: any) => {
  try {
    setIsLoading(true)
...
export const postDesagruparActas = async (actasIds: any[], onSuccess: any, setIsLoading: any) => {
  try {
    setIsLoading(true)
...
export const getGrupoActa = async (actaId: any, setIsLoading: any, setGrupoState: any) => {
  try {
    setIsLoading(true)
...
export const getGrupoActaDetail = async (grupoId: any, setGrupoDetail: any, setIsLoading: any) => {
  try {
    setIsLoading(true)
...
export const getCaratulaActa = async (actaId: string | number): Promise<CaratulaResponse> => {
